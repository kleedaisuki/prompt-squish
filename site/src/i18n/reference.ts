...
const en = {
  ...
  "ns": {
    ...
    "resources": "Resources",
    "specification": "0.2.0 normative DSL specification (Simplified Chinese)",
    "tagged": "Specification at the release tag",
    ...
    "contract": "Contract",
    "elements": [
      "Source declaration container and implicit main.",
      ...
      "Call a statically referenced source unit's main.",
      "Invoke a statically resolved macro QName.",
...
const zh: typeof en = {
  ...
  "ns": {
    ...
    "resources": "规范资源",
    "specification": "0.2.0 规范性语言文档（简体中文）",
    "tagged": "发布标签中的规范",
    "migration": "发布与迁移说明",
    "examples": "可运行示例",
    "vocabulary": "核心元素",
